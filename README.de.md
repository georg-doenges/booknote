...
Booknote spricht **Deutsch, English und Français**: Die App folgt der Sprache
deines Handys (änderbar unter *Einstellungen → App-Sprache*), und deine Notizen
kannst du in jeder der drei Sprachen aufnehmen — pro Buch eingestellt, bei
Bedarf auch pro Aufnahme.

Kennst du dich aus, schalte den **Clean Mode** ein (*Einstellungen → Anzeige*):
Er blendet die Erklärungen und Hinweise aus und lässt nur Knöpfe und
Überschriften übrig.
...
Die Texte der App stehen in `lib/l10n/app_{de,en,fr}.arb`; nach Änderungen
